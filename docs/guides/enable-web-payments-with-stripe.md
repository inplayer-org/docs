...
- [**JavaScript SDK**](#javascript-sdk): Use for a direct integration between the app and JWP.
- [**REST API**](#rest-api): Use this for integrations where the app communicates with JWP using middleware.
